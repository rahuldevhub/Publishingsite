...
import { FOOTER_GUIDES } from "@/lib/internal-links";

const QUICK_LINKS = [
  { label: "Home",                 href: "/" },
  { label: "About Us",             href: "/aboutus" },
  { label: "Self-Publishing Packages", href: "/packages" },
...
const SOCIAL = [
  {
    label: "Instagram",
    href: "https://www.instagram.com/ritera_publishing?igsh=ZngwdW85N3htaGky",
    icon: (
  ...
  {
    label: "LinkedIn",
    href: "https://www.linkedin.com/company/ritera-publishing",
    icon: (
      <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    label: "Medium",
    href: "https://medium.com/@riterapublishing",
    icon: (
      <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
    ...
    <footer className="bg-gray-900 text-gray-300">
      ...
      <div className="max-w-7xl mx-auto px-6 pt-16 pb-10">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-10 lg:gap-8">
          ...
          {/* Col 4 — Publishing Guides */}
          <div>
            <p className="text-[10px] font-bold text-white uppercase tracking-widest mb-5">
              Publishing Guides
            </p>
            <ul className="space-y-3">
              {FOOTER_GUIDES.map(({ label, href }) => (
                <li key={href}>
                  <Link
                    href={href}
                    className="text-sm text-gray-400 hover:text-white transition-colors"
