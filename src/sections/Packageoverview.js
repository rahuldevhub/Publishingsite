...
const Packageoverview = () => {
    ...
    return (
        <div className='Packageoverview'>
            ...
            <p className='subtitle' >Tale a look on our range of six perfectly tailored packages, designed to meet your needs and exceed your expections, all at a price that ensure satisfaction without compromise</p>
