...
const bookdata = [
    {
        ...
        description: `"Jade Julep: An Anthology" is a remarkable collection of poems written by ten different authors around the world. This anthology explores unspoken struggles, the chaos of the world, the fighting spirit of African people, personal losses, the pain artists feel, and the lasting power of love. Each poem provides a look into the human soul, showing our shared experiences of resilience and hope.
    ...
    },
    {
        ...
        description: `Step into a realm where faith meets revelation, and ordinary lives are transformed into extraordinary journeys. Revelations of Infinite Life is more than a book-it is an invitation to experience the profound truths of God's love and the power of living a Spirit led life.
...
Let these revelations elevate your walk with God, reignite your passion for His presence, and empower you to embrace the infinite life He has destined for you.
    ...
    //     url3: '#',
    //     authorbio: ``,
    //     description: `Parenting, Mental Health, and Discrimination are the key topics that SOMEDAY PERHAPS focuses on. Even though several books have been written on this topic, this book has been crafted after encountering these issues in real life. A little girl and an old man are just trying to be a part of our lives, and teaching us the best way to make this world a slightly better place to live.`
    ...
    // },
    {
        ...
        url3: '#',
        authorbio: ``,
        description: `An intriguing Psychological Romantic-Comedy Novel that takes you into the world of Juan and Esther, a San Diego couple in the 1980s.
